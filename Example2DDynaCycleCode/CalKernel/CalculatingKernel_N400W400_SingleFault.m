...
save(['ElementCut_N',num2str(length(element_location_x1)),'W',num2str(Fault(1).Length),'_SingleFault.mat'],'ElementCut','-v7.3')
save(['KernelInfo_N',num2str(length(element_location_x1)),'W',num2str(Fault(1).Length),'_SingleFault.mat'],'KernelInfo','-v7.3')
save(['Fault_N',num2str(length(element_location_x1)),'W',num2str(Fault(1).Length),'_SingleFault.mat'],'Fault','-v7.3')

save(['MatrixKernel_N',num2str(length(element_location_x1)),'W',num2str(Fault(1).Length),'_SingleFault.mat'],'Kernel_K11_all','Kernel_K12_all','Kernel_K22_all','-v7.3')
