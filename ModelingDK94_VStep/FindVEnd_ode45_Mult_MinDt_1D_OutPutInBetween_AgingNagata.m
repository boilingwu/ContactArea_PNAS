...
function [tau_ext,sigma,v,slip,theta,t_out] = FindVEnd_ode45_Mult_MinDt_1D_OutPutInBetween_AgingNagata(tau_ext_start,sigma_start,...
...
%         tspan, y0,options);% add option, absolute tol, relative tol, max time step
    [t_out,y_out] = ode45(@(t,y) RSmarching_RD_mult_1D_AgingNagata(t,y,Kshear_matrix,Knormal_matrix,Dc,G,Cs,a,b,mu0,V0,Theta0,v_load,c),...
        tspan, y0,options);% add option, absolute tol, relative tol, max time step
